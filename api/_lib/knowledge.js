...
Chat hướng dẫn: góc phải dưới Trang chủ có nút nổi "Người hướng dẫn" mở khung chat TRẢ LỜI TỨC THÌ các câu hỏi hướng dẫn sử dụng ngay trong trình duyệt (theo kịch bản soạn sẵn, miễn phí, không giới hạn); câu ngoài kịch bản được hỏi AI ngay trong khung, miễn phí 3 lượt/ngày mỗi khách (khung này không đọc được số liệu thật). Hết lượt, hoặc cần số liệu thật, thì chat với trợ lý AI (chính là bạn) qua hai kênh — Zalo OA "VP Đoàn ĐBQH và HĐND tỉnh Thanh Hóa" (https://zalo.me/142053241153738721) và Telegram @hdnd_thanhhoa_bot (https://t.me/hdnd_thanhhoa_bot). Lần đầu nhắn tin phải gửi "/dangky Họ và tên - Đơn vị" và chờ Quản trị duyệt.
