...
export const MODULES = [
  {
    ...
    short: 'Biểu quyết',
    desc: 'Biểu quyết trực tuyến tại kỳ họp HĐND tỉnh: chọn kỳ họp, đại biểu bấm Đồng ý · Không đồng ý · Có ý kiến khác cho từng nghị quyết hoặc một lần cho tất cả nghị quyết của kỳ họp; hệ thống kiểm phiếu ngay trên tổng số 82 đại biểu, hiện bảng điện tử và đối chiếu điều kiện thông qua.',
